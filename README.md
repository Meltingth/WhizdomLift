...
🔧 **อัปเกรด firmware:** [FIRMWARE_UPGRADE.md](FIRMWARE_UPGRADE.md) — ทำที่เครื่องหน้าตู้ผ่าน USB เท่านั้น

🌐 **เครื่อง Gateway (รับ 5 ลิฟต์พร้อมกัน):** [GATEWAY.md](GATEWAY.md)

🔧 **แยกบอร์ดรีเลย์เสีย vs สาย input ขาด:** [LIFT1_VS2_RELAY_TEST.md](LIFT1_VS2_RELAY_TEST.md) — ขั้นตอนหน้าตู้สำหรับ Lift 1 VS2
...
| `GATEWAY.md` | คู่มือเครื่อง Gateway: รับ 5 ลิฟต์ผ่าน RS485 พร้อมกัน |
| `FIRMWARE_UPGRADE.md` | ขั้นตอนอัปเกรด firmware และสิ่งที่ Gateway จะเห็นระหว่างนั้น |
...
| `rs485_check.py` | ตรวจลิงก์ RS485 แบบไม่ส่งอะไรออกสาย: `python rs485_check.py COM3 1` — บอกว่าบัสมีคนขับหรือไม่ |
...
# LMS-NG Claude Code Workflow Kit v1.0 (2026-09-03)
